    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_MasterCategories", x => new { x.MasterProfileId, x.CategoryId });
                    table.ForeignKey(
                        name: "FK_MasterCategories_Categories_CategoryId",
                        column: x => x.CategoryId,
                        principalTable: "Categories",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_MasterCategories_MasterProfiles_MasterProfileId",
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { new Guid("0ef1f5a5-52dd-425a-a19d-d2934aef969d"), null, "Client", "CLIENT" },
                    { new Guid("de27c051-663d-4990-b0fe-b8b5e4677f33"), null, "Master", "MASTER" },
                    { new Guid("f2d5d628-e57f-4a1f-9b65-24e3ea02f121"), null, "Admin", "ADMIN" }
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_MasterCategories_CategoryId",
